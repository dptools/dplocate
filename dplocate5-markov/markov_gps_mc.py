...
def main():
    argparser = ap.ArgumentParser('PHOENIX wrapper for Phone gps Pipeline',
    ...
    argparser.add_argument('--extension',
        help='File extension of power files',
        default='.csv')
    ...
    for study in studies:
        ...
        for subject in subjects:
            ...
            data_path = os.path.join(subject_path, args.data_type, 'processed/gps_dash2')
            output_path = args.output_dir if args.output_dir else os.path.join(args.consent_dir)
